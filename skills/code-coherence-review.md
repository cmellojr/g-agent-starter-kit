...
4. **Duplication detection.** Scan the changed code for logic, patterns, or methods that duplicate existing functionality in the codebase. For each changed file, check:
